    ...
    <footer className="border-t border-border bg-secondary/50">
      <div className="mx-auto max-w-6xl px-5 py-14">
        <div className="flex flex-wrap items-center gap-3">
          ...
          />
          <span className="text-sm font-bold text-ink">IBK기업은행</span>
        </div>

        <p className="mt-6 text-sm leading-relaxed text-muted-foreground">
          본 콘텐츠는 IBK기업은행 B-RETAIL 카드 및 B-F&B 카드의 주요 혜택을 알기 쉽게 소개하기
          위한 홍보 콘텐츠입니다. 카드 이용 전 상품설명서 및 약관을 반드시 확인하시기 바랍니다.
        </p>

        <div className="mt-8 grid min-w-0 gap-6 border-t border-border pt-8 text-sm sm:grid-cols-2 lg:grid-cols-[repeat(4,minmax(0,1fr))]">
